...
const ServiceDetail = () => {
  ...
  usePageMeta({
    title: service ? `Vita Constructions | ${service.title}` : "Vita Constructions | Service Not Found",
    description: service ? service.shortDesc : "Service not found.",
  });
      ...
      <section className="py-16 md:py-20 bg-background">
        <div className="max-w-[1170px] mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
              <h2 className="text-[28px] md:text-[42px] font-bold mb-2">{service.title}</h2>
              <SectionSeparator />
