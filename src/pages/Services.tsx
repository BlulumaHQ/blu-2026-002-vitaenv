              ...
              <motion.div key={service.slug} variants={fadeUp} className="bg-background border border-border overflow-hidden group">
                ...
                <div className="p-6">
                  ...
                  <Link
                    ...
                    className="border border-foreground text-foreground text-xs font-bold px-5 py-2 hover:bg-foreground hover:text-background transition-colors inline-flex items-center gap-1"
                  >
